...
{
    public partial class CheckAvailability : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DayPilotScheduler1.StartDate = new DateTime(DateTime.Today.Year, 9, 1);
            DayPilotScheduler1.Days = Year.Days(DateTime.Today.Day);
